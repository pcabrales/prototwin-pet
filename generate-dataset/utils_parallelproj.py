...
def parallelproj_listmode_reconstruction(
    psf_path,
    ...
    events_phi = (
        xp.digitize(events_phi, crystal_phi_positions) * 2 * xp.pi / num_sides - xp.pi
    ...
    events_z = (
        xp.digitize(xp.asarray(events_z), crystal_z_positions) * 2 * max_z / num_rings
        - max_z
